...
namespace AnalyticsProject.Helpers
{
    public class Twitter
    {
        ...
        public string GetMentions(int count)
        {
            ...
            var response = GetResponse(resourceUrl, Method.GET);
        ...
        {
            string resourceUrl =
                string.Format("https://api.twitter.com/2/tweets/search/recent?query=from:ItColdHearted15");
        ...
        public string PostStatusUpdate(string status, double latitude, double longitude)
        {
            ...
            return GetResponse(resourceUrl, Method.POST);
        }

        private string GetResponse
        (string resourceUrl, Method method)
        {
